...
import com.metaled.databinding.CartRowBinding
...
val list:ArrayList<String>?
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding: CartRowBinding = CartRowBinding.inflate(layoutInflater, parent, false)
    ...
    class ViewHolder(binding: CartRowBinding) : RecyclerView.ViewHolder(binding.getRoot()) {
