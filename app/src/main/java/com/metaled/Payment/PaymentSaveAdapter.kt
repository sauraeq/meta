...
import com.metaled.databinding.PaymentLayoutRowBinding
...
class PaymentSaveAdapter (
...
): RecyclerView.Adapter<PaymentSaveAdapter.ViewHolder>()  {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        //val v= LayoutInflater.from(parent.context).inflate(R.layout.company_rows,parent,false)
        //return Holder(v)
        val layoutInflater = LayoutInflater.from(parent.context)
        val binding: PaymentLayoutRowBinding = PaymentLayoutRowBinding.inflate(layoutInflater, parent, false)
    ...
    class ViewHolder(binding: PaymentLayoutRowBinding) : RecyclerView.ViewHolder(binding.getRoot()) {
        var binding: PaymentLayoutRowBinding
